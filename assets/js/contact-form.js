(function () {
  ...
  $(document).ready(function() {
    if ($("#phone").intlTelInput) {
      $("#phone").intlTelInput({validationScript: "/assets/intl-tel-input/js/isValidNumber.js"});
    ...
    $("#feedbackSubmit").click(function() {
      ...
      $.ajax({
        ...
        success: function(data) {
          ...
          $('#captcha').attr('src', '/assets/vender/securimage/securimage_show.php?' + Math.random());
        },
