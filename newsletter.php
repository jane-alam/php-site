...
<style>
  ...
  #backgroundTable {
    ...
    @media only screen and (max-width: 600px) {
        ...
        table[class="body"] .hide-for-small, table[class="body"] .show-for-lg {
            display: none !important;
        }
        table[class="body"] .show-for-small, table[class="body"] .hide-for-lg {
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td class="six sub-columns">
                                                                        <img src="http://placehold.it/200x50" class="img-responsive">
                                                                    </td>
                                                                    <td class="six sub-columns last" style="text-align:right; vertical-align:middle;"> <span class="template-label label-default">News Letter</span>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                  ...
                                                                  <p class="lead">Remember to apply the <a href="http://www.bootstrapcdn.com/">bootstrapcdn</a> for this to work on a simple singular script</p><a href="http://www.bootstrapcdn.com/">
                                                                    <p>Phasellus dictum sapien a neque luctus cursus. Pellentesque sem dolor,
                                                                        fringilla et pharetra vitae. consequat vel lacus. Sed iaculis pulvinar
                                                                        ligula, ornare fringilla ante viverra et. In hac habitasse platea dictumst.
                                                                        Donec vel orci mi, eu congue justo. Integer eget odio est, eget malesuada
                                                                        lorem. Aenean sed tellus dui, vitae viverra risus. Nullam massa sapien,
                                                                        pulvinar eleifend fringilla id, convallis eget nisi. Mauris a sagittis
                                                                        dui. Pellentesque non lacinia mi. Fusce sit amet libero sit amet erat venenatis
                                                                        sollicitudin vitae vel eros. Cras nunc sapien, interdum sit amet porttitor
                                                                        ut, congue quis urna.</p>
                                                                </a></td>
                                                                <td class="expander"></td>
                                                            </tr>
                                                        </tbody>
                                                    ...
                                                    <table class="twelve columns">
                                                        <tbody>
                                                            <tr>
                                                                <td class="panel">
                                                                    <p>Phasellus dictum sapien a neque luctus cursus. Pellentesque sem dolor,
                                                                        fringilla et pharetra vitae. <a href="#">Click it! »</a>
                                                                    </p>
                                                                </td>
                                                                <td class="expander"></td>
                                                            </tr>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td class="last right-text-pad">
                                                                    ...
                                                                    <p>Email: <a href="mailto:#">email@company.com</a>
                                                                    </p>
                                                                </td>
                                                                <td class="expander"></td>
                                                            </tr>
